...
import com.project.bizmq.BiMessageProducer;
...
import com.project.manager.RedisLimiterManager;
import com.project.model.dto.chart.*;
import com.project.model.entity.Chart;
import com.project.model.entity.User;
import com.project.model.mongo.UserChart;
import com.project.model.vo.BiResponse;
...
public class ChartController {
    ...
    public BaseResponse<Page<UserChart>> listMyChartByPage(@RequestBody ChartQueryRequest chartQueryRequest,
                                                       HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(size > 20, ErrorCode.PARAMS_ERROR);
        // 分页查询
        Page<UserChart> chartPage = chartMongoService.page(current, size, loginUser.getId());
...
//                getQueryWrapper(chartQueryRequest));
    ...
    public BaseResponse<BiResponse> genChartByAi(@RequestPart("file") MultipartFile multipartFile,
        ...
        biResponse.setChartId(String.valueOf(userChart.getId()));
    ...
    public BaseResponse<BiResponse> genChartByAiAsync(@RequestPart("file") MultipartFile multipartFile,
        ...
        try {
            CompletableFuture.runAsync(() -> {
                ...
                chartMongoService.update(loginUser.getId(), updateChart);
                ...
                String[] splits = result.split("【【【【【");
                if (splits.length < 3) {
                    handleChartUpdateError(userChart.getId().getTimestamp(), "AI 生成错误");
                    return;
                }
                String genChart = splits[1].trim();
                String genResult = splits[2].trim();
                ...
                chartMongoService.update(loginUser.getId(), updateChartResult);
            }, threadPoolExecutor);
        } catch (Exception e) {
            log.error("异步执行失败");
        }
    ...
    public BaseResponse<BiResponse> genChartByAiAsyncMq(@RequestPart("file") MultipartFile multipartFile,
        ...
        // 构造消息体，并发送
        String chartId = String.valueOf(userChart.getId());
        HashMap<String, String> messageMap = new HashMap<>();
        messageMap.put("userId", String.valueOf(loginUser.getId()));
        messageMap.put("chartId",chartId);
        biMessageProducer.sendMessage(messageMap);
